...
private:
    ...
    GLfloat initCube[5*36] = {
        -1.0f,-1.0f,-1.0f,   0.0f, 0.0f, /* 0-29 bottom: white */
         1.0f,-1.0f,-1.0f,   1.0f/3.0f, 0.0f,
        -1.0f,-1.0f, 1.0f,   0.0f, 1.0f/3.0f,
         1.0f,-1.0f,-1.0f,   1.0f/3.0f, 0.0f,
         1.0f,-1.0f, 1.0f,   1.0f/3.0f, 1.0f/3.0f,
        -1.0f,-1.0f, 1.0f,   0.0f, 1.0f/3.0f,
        -1.0f, 1.0f,-1.0f,   0.0f, 1.0f/3.0f, /* 30-59 top: yellow */
        ...
        -1.0f, 1.0f, 1.0f,   0.0f, 1.0f/3.0f,
         ...
         1.0f, 1.0f, 1.0f,   1.0f/3.0f, 1.0f/3.0f,
        -1.0f, 1.0f, 1.0f,   0.0f, 1.0f/3.0f,
        -1.0f,-1.0f,-1.0f,   1.0f/3.0f, 0.0f, /* 90-119 back: orange */
        -1.0f, 1.0f,-1.0f,   1.0f/3.0f, 1.0f/3.0f,
         1.0f,-1.0f,-1.0f,   0.0f, 0.0f,
         1.0f,-1.0f,-1.0f,   0.0f, 0.0f,
        -1.0f, 1.0f,-1.0f,   1.0f/3.0f, 1.0f/3.0f,
         1.0f, 1.0f,-1.0f,   0.0f, 1.0f/3.0f,
        -1.0f,-1.0f, 1.0f,   1.0f/3.0f, 0.0f, /* 120-149 left: blue */
        -1.0f, 1.0f,-1.0f,   0.0f, 1.0f/3.0f,
        -1.0f,-1.0f,-1.0f,   0.0f, 0.0f,
        -1.0f,-1.0f, 1.0f,   1.0f/3.0f, 0.0f,
        -1.0f, 1.0f, 1.0f,   1.0f/3.0f, 1.0f/3.0f,
        -1.0f, 1.0f,-1.0f,   0.0f, 1.0f/3.0f,
         1.0f,-1.0f, 1.0f,   0.0f, 0.0f, /* 150-179 right: green */
         1.0f,-1.0f,-1.0f,   1.0f/3.0f, 0.0f,
         1.0f, 1.0f,-1.0f,   1.0f/3.0f, 1.0f/3.0f,
         1.0f,-1.0f, 1.0f,   0.0f, 0.0f,
         1.0f, 1.0f,-1.0f,   1.0f/3.0f, 1.0f/3.0f,
